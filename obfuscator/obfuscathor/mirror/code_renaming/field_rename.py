...
class FieldRename(obfuscator_category.IRenameObfuscator):
    ...
    def rename_field(self, field_name: str) -> str:
        if field_name in self.dict:
            return self.dict[field_name]
        elif self.dictionary:
            field_obfuscated = random.choice(list(self.dictionary))
            self.dict[field_name] = field_obfuscated
    ...
    def obfuscate(self, obfuscation_info: Obfuscation):
        ...
        try:
            ...
            self.load_dictionary('./dict_confusion/dict_confusion_fields.txt')
